...
public class DeployTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            serverCluster.setIbisHubBroker(new URI(
                    "any://fs0.das3.cs.vu.nl/jobmanager-fork"));
            serverCluster.setJavapath("/usr/local/package/jdk1.6.0");
            serverCluster
                    .setApplicationFileAdaptors("local, gridftp, sshtrilead");
            serverCluster
                    .setApplicationBrokerAdaptors("local, globus, sshtrilead");
