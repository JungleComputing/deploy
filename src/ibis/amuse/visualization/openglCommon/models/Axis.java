...
public class Axis extends Model {
    public Axis(Program program, Material material, VecF3 start, VecF3 end, float majorInterval, float minorInterval) {
    ...
    private int addInterval(VecF4[] points, VecF3[] normals, VecF3[] tCoords, int arrayindex, VecF3 center, VecF3 alignment,
            float size) {
