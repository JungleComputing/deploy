...
public class JungleGoggles implements GLEventListener {
    ...
    private double aspect, width, height;

    private final double zNear, zFar;

    // View variables
    private float viewDist;
    private final Float[] viewTranslation;
    ...
    private final HashMap<Integer, JGVisual> namesToParents;

    // Universe
    DisplayListBuilder listBuilder;
    private JGUniverse universe;
    private final HashMap<Element, JGVisual> visualRegistry;
    private final HashMap<Element, JGVisual> linkRegistry;
    ...
    private final boolean[] particleInUse;
    private final ParticleTimer ptimer;
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        // Get the current opengl instance, and clear the depth and color
        // buffers
        GL2 gl = drawable.getGL().getGL2();
