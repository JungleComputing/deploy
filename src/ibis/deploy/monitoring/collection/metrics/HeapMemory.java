...
public class HeapMemory extends
    ...
    private static final Logger logger = LoggerFactory
            .getLogger("ibis.deploy.monitoring.collection.metrics.HeapMemory");

    public static final String MAX = "max";
    public static final String USED = "used";
    public static final String ATTRIBUTE_NAME_HEAP_MEMORY_USAGE = "HeapMemoryUsage";
    public static final String MEM_HEAP = "MEM_HEAP";
    ...
    public HeapMemory() {
        ...
        necessaryAttributes.add(new AttributeDescription(
                "java.lang:type=Memory", ATTRIBUTE_NAME_HEAP_MEMORY_USAGE));
