...
public class Workspace {
    ...
    /**
     * Constructs a workspace object from properties stored in the given file. Also
     * constructs the grid, applications and experiment within the workspace.
     * 
     * @param file
    ...
    public Workspace(File file) throws Exception {
        ...
        if (!fileName.endsWith(".workspace")) {
            throw new Exception("workspace files must have a \".workspace\" extension");
        }
