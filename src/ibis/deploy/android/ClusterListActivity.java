 ...
 */
public class ClusterListActivity extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent editIntent = new Intent(ClusterListActivity.this,
                ClusterEditorActivity.class);
        editIntent
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            try {
                mAdapter = new ArrayAdapter<String>(ClusterListActivity.this,
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        try {
            mDeployService.deleteCluster(selectedItem);
        } catch (RemoteException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    mDeployService.createNewCluster(name);
                    mAdapter.add(name);
                } catch (RemoteException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
        ...
        return new AlertDialog.Builder(this).setTitle("Enter Cluster Name")
