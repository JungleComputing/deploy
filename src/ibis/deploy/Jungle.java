...
/**
 * Jungle containing resources. Basically just a HashMap with resource objects, and
 * some functions for loading and saving jungles.
 * 
 * @author Niels Drost
 * 
 */
public class Jungle {
    ...
    /**
     * Constructs a jungle object from properties stored in the given file. Also
     * constructs the resources inside this jungle.
     * 
     * @param file
     *            the file containing the properties
     ...
     *             invalid properties
     */
    public Jungle(File file, boolean tryClasspath) throws FileNotFoundException,
            Exception {
        resources = new ArrayList<Resource>();

        if (!file.getName().endsWith(".jungle")) {
            throw new Exception("jungle files must have a \".jungle\" extension");
        }
    ...
    /**
     * Removes the resource with the given name from the jungle (if it belongs to
     * the jungle at all).
     * 
     * @param name
    ...
    public void addResource(Resource resource) throws Exception {
        if (hasResource(resource.getName())) {
            throw new AlreadyExistsException(
                    "Cannot add resource, resource with name \""
    ...
    public void save(File file) throws Exception {
        ...
        out.println("# Jungle file, " + "generated by Ibis Deploy on "
