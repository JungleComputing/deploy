...
public class CpuUsage extends SingleStat {
	private long cpu_prev;
	private long upt_prev;		

	public CpuUsage(PerfVis perfvis, IbisIdentifier ibis, Float[] colors) {
	...
	public void update() throws Exception {	
		...
		if (perfvis.getSelection() == glName) {
			if (zoomLevel == PerfVis.ZOOM_NODES && zoomStat == PerfVis.STAT_CPU) {
