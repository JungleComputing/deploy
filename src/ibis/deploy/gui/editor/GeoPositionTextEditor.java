...
public class GeoPositionTextEditor 
{
    ...
    public GeoPositionTextEditor(JPanel parent, final String text, Object value, boolean fitLabel) 
    {
        ...
        //set the format for the textfields - they will only allow a maximum of 4 decimal and a minimum of 1
        ...
        formatter.setAllowsInvalid(false);//invalid values - containing letters and such - are automatically discarded
