...
public class Hdf5Snapshotter {
    ...
    public void open(String namePrefix, GLWindow glw, Program starProgram, Program gas, int currentFrame) {
        ...
        try {
            ...
            cubeRoot = new OctreeNode(GLWindow.max_elements_per_octree_node_in_snapshot, 0, cloudModels, new Vec3(
            ...
            particleMemberList = Hdf5StarReader.getRoot(namePrefix + intToString(currentFrame) + evoNamePostfix)
                    .getMemberList();
            Hdf5StarReader.traverse("evo", particleResult, particleMemberList);

            particleMemberList = Hdf5StarReader.getRoot(namePrefix + intToString(currentFrame) + gravNamePostfix)
                    .getMemberList();
