...
public class Axis extends Model {
    ...
    public Axis(Material material, Vec3 start, Vec3 end, float majorInterval, float minorInterval) {
    ...
    private int addInterval(Vec4[] points, Vec3[] normals, Vec3[] tCoords, int arrayindex, Vec3 center, Vec3 alignment,
            float size) {
