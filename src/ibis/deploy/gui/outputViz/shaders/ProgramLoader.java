...
public class ProgramLoader {
    ...
    public Program createProgram(GL3 gl, String vs_src, String fs_src) throws FileNotFoundException, CompilationFailedException {
    ...
    public Program createProgram(GL3 gl, String vs_src, String gs_src, String fs_src) throws FileNotFoundException, CompilationFailedException {
        VertexShader vs = new VertexShader(vs_src);
        vs.init(gl);
