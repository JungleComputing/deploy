...
void main()
{
	...
	//normal = 10 * vec4(cross(gl_PositionIn[2].xyz - gl_PositionIn[0].xyz, gl_PositionIn[1].xyz - gl_PositionIn[0].xyz), 1.0);
    //gl_Position = gl_PositionIn[0] + normal;
    //EyespaceNormalOut = EyespaceNormal[0];
    //EmitVertex();   
    
    //normal = 10 * vec4(cross(gl_PositionIn[0].xyz - gl_PositionIn[1].xyz, gl_PositionIn[2].xyz - gl_PositionIn[1].xyz), 1.0);
    //gl_Position = gl_PositionIn[1] + normal;
    //EyespaceNormalOut = EyespaceNormal[1];
    //EmitVertex();   
    
    //normal = 10 * vec4(cross(gl_PositionIn[1].xyz - gl_PositionIn[2].xyz, gl_PositionIn[0].xyz - gl_PositionIn[2].xyz), 1.0);
