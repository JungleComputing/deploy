...
public class GridVisionPanel extends JPanel {
    ...
    public void initialize(GUI gui) {
        ...
        JMenu refresh = makeRadioGroup(perfvis, "Refresh delay (in ms)",
                refreshgroup, "500");
        bar.add(refresh);
    ...
    private JMenu makeRadioGroup(GridVision perfvis, String menuName,
            String[] itemNames, String initial) {
